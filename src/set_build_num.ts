...
export function set_build_num(): void {
	...
	let build_src: string | undefined 	= 	Arg.v_enum_null('src', ['git'])
	...
	let build_number: number			= 	(build_src === 'git') ?
		Tools.version_from_git('develop')	: 	Arg.v_number('num')
	if (base_num) {
		build_number = build_number + base_num
	}
